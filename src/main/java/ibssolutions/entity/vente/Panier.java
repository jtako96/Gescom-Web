...
public class Panier implements Serializable {
	...
	@ManyToOne
	@JoinColumn(name = "id_proforma" , nullable = true)
	...
	public Panier(Stock stock, Vente vente) {
		super();
		this.stock = stock;
		this.vente = vente;
	}
	...
	public Panier(String description, String reference, double remise, double montantHT, double montantTVA,
			double montantTTC, double montantRemise, Stock stock, Vente vente) {
		super();
